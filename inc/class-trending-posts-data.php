...
if ( ! class_exists( 'TM_Trending_Posts_Data' ) ) {
	/**
	 * Class for Trending Post data.
	 *
	 * @since 1.0.0
	 */
	class TM_Trending_Posts_Data {
		...
		public function __construct() {
			 ...
			 * @since 1.0.0
			 */
			// add_action( 'tm_get_trending_posts', array( $this, 'the_data' ) );
		}
		...
		public function query( $args = array(), $context = '' ) {
			 ...
			 */
			$args = apply_filters( 'tm_trending_posts_wp_query_args', $args, $context );
